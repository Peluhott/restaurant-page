...
const textForMain = document.createElement('div')
textForMain.className = 'textForMain';
...
textForMain.append(shortDescription, buttonForMain)
mainDescription.append(imageForMain,textForMain);
